...
// send mail
const sendEmail = (to,num,date1,echa,facture,totalHorsTva,subTotal,txt,Acompte,adresse,codePostale,nomFacture,remiseParLignePourcent,total,remise,totalRemise) => {

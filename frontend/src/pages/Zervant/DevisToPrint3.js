...
<div className={styles.invoiceSummary} style={{marginLeft:"0px" ,marginTop:"50px"}}>
          ...
          <div className={styles.summaryItem}>
        <p>Remise :</p>
        <h4>{devis.remisetotal2}</h4>
          </div>

          <div className={styles.summaryItem}>
                  <p>Total dû</p>
                <h4 name="subTotal" style={{color: "grey", fontSize: "18px", lineHeight: "8px"}}>{(subTotal -devis.remisetotal2).toFixed(2)}</h4>
            </div>

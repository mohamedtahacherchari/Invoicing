...
import { envoyerMailAvecRemiseParLigneEnPourcentage, listDevisDetails, updateDevis } from '../../redux/actions/servantActions/devisAction';
...
<div class="remise-container">
        Remise : {devis.remiseParLignePourcent}
    </div>

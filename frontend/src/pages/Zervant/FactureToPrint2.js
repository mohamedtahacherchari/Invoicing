...
import { listFactureDetails, updateFacture,envoyerMailAvecRemiseTotalEnPourcentage } from '../../redux/actions/servantActions/factureAction';
...
import { envoyerMailAvecRemiseTotalEnPourcentageReducer } from '../../redux/reducers/zervantReducers/FactureReducer';
    ...
    updateFacture({
     ...
     onAfterPrint : ()=> alert('Print success')
      ...
      const envoyerMailAvecRemiseTotal = async()=>{
        ...
        try {
          await envoyerMailAvecRemiseTotalEnPourcentage(id, token)(dispatch);
        } catch (error) {
...
<Table className={classes.table} aria-label="simple table">
    ...
    value={itemField.montant= (itemField.qte*itemField.prix)+(itemField.qte*itemField.prix)*itemField.tva/100}/> 
      ...
      <td>
          <Typography style={{marginLeft:"75px", width:"30px"}}>{facture.remisetotal}%</Typography>
         </td>
         </tbody>
         </table>
              </div>
<div className={styles.invoiceSummary} style={{marginLeft:"0px" ,marginTop:"50px"}}>
          <div className={styles.summary}>Résumé de facture</div>

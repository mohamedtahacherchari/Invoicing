...
import { listDevisDetails, updateDevis,envoyerMailSansRemise } from '../../redux/actions/servantActions/devisAction';
     ...
     onAfterPrint : ()=> alert('Print success')
      ...
      const envoyermailSansRemise = async()=>{
        ...
        try {
          ...
          console.log(pdfData);
       // const pdf =  pdfData.split('base64,')[1]
         await envoyerMailSansRemise(id,token,pdfData)(dispatch);
        } catch (error) {

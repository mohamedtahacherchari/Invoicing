    ...
    updateFacture({
     ...
     const envoyerMailAvecRemiseParLigne = async()=>{
      ...
      try {
        ...
        console.log(pdfData);
        await envoyerMailAvecRemiseParLigneEnPourcentage(id,token,pdfData)(dispatch);
      } catch (error) {
...
return (
      ...
      <TableBody>
        {invoiceData.items.map((itemField, index) => (
          <TableRow key={index}>
            ...
            <TableCell>{itemField.remisePourcent}</TableCell>
  ...
  <div class="remise-container">
         Totale de remise en devise : {facture.remiseParLignePourcent} 
      </div>
